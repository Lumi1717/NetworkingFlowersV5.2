...
public class FlowerRepository {
    ...
    public static class deleteAsyncTask extends AsyncTask<FlowerModel,Void,Void>
    {
        private FlowerDAO mAsyncTaskDao;
        ...
        @Override
        protected Void doInBackground(FlowerModel... flowerModels) {
            mAsyncTaskDao.delete(flowerModels[0]);
            return null;
        }
    }
}
